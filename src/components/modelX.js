...
import modelX_BackgroundPic from "../img/modelX_BackgroundPic.jpg";
import modelX_Mobile_BackgroundPic from "../img/modelX_Mobile_BackgroundPic.jpg";
import CarDetailPicture from "./segments/CarDetailPicture";
import insidePic from "../img/inside2.jpg";
import Footer from "./Footer";

const stars = [
  <i className="fa fa-star" aria-hidden="true" key="star1"></i>,
  <i className="fa fa-star" aria-hidden="true" key="star2"></i>,
  <i className="fa fa-star" aria-hidden="true" key="star3"></i>,
  <i className="fa fa-star" aria-hidden="true" key="star4"></i>,
  <i className="fa fa-star" aria-hidden="true" key="star5"></i>,
];
    ...
    <div className="page">
      ...
      <ModelX>
        ...
        <CarInformation
          ...
          title_3={stars}
          subTitle_1="Range"
          subTitle_2="Full Recharge"
          subTitle_3="5-star safety"
        ></CarInformation>
      </ModelX>
      <CarDetail
...
const ModelX = styled.div`
  ...
  background-image: url(${modelX_BackgroundPic});

  @media (max-width: 767px) {
    background-image: url(${modelX_Mobile_BackgroundPic});
  }
`;
